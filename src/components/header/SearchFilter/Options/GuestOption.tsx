...
const OptionDescription: React.FC<OptionDescriptionProps> = ({ title, description, }) => (
  <div className="grid">
...
const GuestOption: React.FC = () => {
  const adultCount = useSelector<CountReduxCombinerState, CountReduxCombinerState["guestCount"]["adultCount"]> ((state) => state.guestCount.adultCount);

  const childrenCount = useSelector<CountReduxCombinerState,CountReduxCombinerState["guestCount"]["childrenCount"]> ((state) => state.guestCount.childrenCount);
